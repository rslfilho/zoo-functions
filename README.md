...
Tempo de curso: 1 mês e 26 dias

O objetivo deste projeto era treinar nossas habilidades com HOF's. Nele desenvolvi várias funções para atender aos requisitos abaixos utilizado `JavaScript`.
